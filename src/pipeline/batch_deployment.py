...
class BatchDeployer:
    ...
    def create_model(self, model_name, model_data, image_uri, model_framework='xgboost'):
        """
    ...
    def deploy_best_model_for_batch(self, model_name, model_data, image_uri, test_data_path):
        """
